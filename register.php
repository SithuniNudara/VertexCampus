            ...
            <form id="registrationForm">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">This will be used as your unique identifier</div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="intake">
                            ...
                            for ($x = 0; $x < $rows; $x++) {
                                $data = $rs->fetch_assoc();
                                ?>
                                <option value="<?php echo $data["id"]; ?>"><?php echo $data["intake_name"]; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" class="btn btn-register" onclick="registerS();">Register</button>
                </div>
            </form>
        </div>
    </div>
