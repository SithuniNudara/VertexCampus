        ...
        <div class="registration-container">
            ...
            <form id="registrationForm">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="address" rows="3" required ><?php echo $data['address']; ?>"</textarea>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="contact" class="form-label required-field">Contact Number</label>
                        <input type="tel" class="form-control" id="contact" disabled value="<?php echo $data['mobile']; ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="email" class="form-label required-field">Email</label>
                        <input type="email" class="form-control" id="email" disabled value="<?php echo $data['email']; ?>">
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="course" required>
                            ...
                            for ($x = 0; $x < $rows; $x++) {
                                ...
                                ?>
                                <option value="<?php echo $Coursedata["id"]; ?>" 
                                <?php 
